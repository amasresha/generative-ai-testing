...
Verifies:
- Output types and quality metrics (ROUGE, BLEU)
- Semantic similarity
- Placeholder image generation
- Prompt relevance (good vs random)
"""

from PIL import Image
from src.main import generate, _make_placeholder
import evaluate
...
NUM_IMAGES = 1
ref = (
    "A happy child playing in a green meadow. One day the two of them walk down "
    "the street from him as they leave the home of one of his older brothers."
)
BAD_PROMPT = "Random characters xyz 123 unrelated text"
